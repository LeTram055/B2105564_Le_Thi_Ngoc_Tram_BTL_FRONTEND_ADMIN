    ...
    <tr>
        ...
        <td class="func">
            <div class="btn-container">
                ...
                <btn v-if="borrow.status !== 'Đã hủy' && borrow.status !== 'Đã trả'" nameBtn="Cập nhật" styleBtn="btn-warning" class="btn-item" data-toggle="modal" :data-target="`#modal-${borrow._id}`"></btn>
            </div>
        </td>
    </tr>
